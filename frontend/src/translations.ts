...
export const TRANSLATIONS: Record<'th' | 'en', TranslationData> = {
  th: {
    ...
    about_intro: "สวัสดีฉัน ชื่อ Ice นักศึกษา คณะวิทยาศาสตร์คอมพิวเตอร์ มหาวิทยาลัยรังสิต",
  ...
  en: {
    ...
    about_intro: "Hi! I'm Ice, a Computer Science student at Rangsit University.",
